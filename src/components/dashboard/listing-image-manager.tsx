    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-stone-500">
          ...
          <span className="font-medium text-stone-700">grip</span> (six dots, top-right) to reorder photos. Click another photo to make it the cover. You can select several images at once. JPEG,
          PNG, WebP, or GIF. When{" "}
